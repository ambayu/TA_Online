...
<div class="row">
  <div class="col-md-8" style="width: 80%"> 
      ...
      <div class="step-light-left" >Pilih Siswa</div>
      <div class="step-light-right">&nbsp;</div>
...
$pelajaran=$_GET['id_pelajaran'];
 $q="SELECT * from tbl_nilai INNER JOIN tbl_jadwal ON tbl_nilai.id_kelas=tbl_jadwal.id_kelas and tbl_nilai.id_pelajaran=tbl_jadwal.id_pelajaran where tbl_nilai.id_kelas='$id' and tbl_nilai.id_pelajaran='$pelajaran'";
  $qe=mysql_query($q);
$row =mysql_fetch_array($qe);
$id_guru=$row['id_guru'];
$guru=mysql_fetch_array(mysql_query("select * from data_guru where id_guru='$id_guru'"));
$nama_guru=$guru['nama_guru'];
    $pelajaran=mysql_fetch_array(mysql_query("select * from setup_pelajaran where id_pelajaran='$pelajaran'"));
...
<div class="form-group">
  ...
  <input  name="nama" placeholder="Name guru" value="<?php echo $nama_guru; ?>" class="form-control"  type="text" readonly>
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="nis" value="<?php echo $nama_pelajaran; ?>" placeholder="Nomor induk siswa" class="form-control"  type="text" readonly>
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="kelas" value="<?php echo $id; ?>" placeholder="Nomor induk siswa" class="form-control"  type="text" readonly>
    </div>
  </div>
</div>
...
$id=$_GET['id_siswa'];
 ...
 $q="SELECT * FROM `data_siswa` INNER JOIN `tbl_nilai`  ON  data_siswa.id_siswa=tbl_nilai.id_siswa INNER JOIN `setup_pelajaran` ON setup_pelajaran.id_pelajaran=tbl_nilai.id_pelajaran Where data_siswa.id_siswa='$id'  order by tbl_nilai.id_semester";
  $qe=mysql_query($q);
    $no=0;
