...
<div class="row">
  <div class="col-md-8"> 
      ...
      <div class="step-light-left" >Pilih Pelajaran</div>
      <div class="step-light-right">&nbsp;</div>
      <div class="step-no-off">3</div>
      <div class="step-light-left" >Laporan Penilaian</div>
      <div class="step-light-right">&nbsp;</div>
      <div class="step-no-off">4</div>
      <div class="step-light-left">Cetak Raport Siswa</div>
       <div class="step-light-right">&nbsp;</div>
     
      <div class="clear"></div>
    <br><br><br><br><br>
  <form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="Penilaian_mapel.php" method="GET"  id="contact_form">
<legend>Pilih Semester</legend>
