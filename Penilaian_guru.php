...
<div class="row">
  <div class="col-md-8"> 
      ...
      <div class="step-dark-left">Pilih Semester</div>
      <div class="step-dark-right"  >&nbsp;</div>
       <div class="step-no-off">2</div>
      <div class="step-light-left">Pilih Semester</div>
      <div class="step-light-right"  >&nbsp;</div>
      
      <div class="step-no-off">3</div>
      <div class="step-light-left" >Laporan Penilaian</div> 
      <div class="clear"></div>
    <br><br><br><br><br>
  <form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="Penilaian_mapel_guru.php" method="GET"  id="contact_form">
<legend>Pilih Semester dan Kelas</legend>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Kelas</label> 
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
   <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><select name="kelas" class="form-control">
<?php
include"conn.php";
...
$id=$guru['id_guru'];
$tampil=mysql_query("SELECT DISTINCT id_kelas FROM tbl_jadwal where id_guru= $id");
 ?>
<?php 
 while($w=mysql_fetch_array($tampil))
{
    echo "<option value=$w[id_kelas]>$w[id_kelas]</option>";        
}
?>
</select>
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-4">&nbsp;
    <button type="submit" class="btn btn-warning" >Pilih <span class="glyphicon glyphicon-send"></span></button>
  </div>
</div>
</form>
 </div>
