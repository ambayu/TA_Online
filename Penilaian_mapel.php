...
<div class="row">
  <div class="col-md-8"> 
     ...
     <div class="step-no-off">1</div>
      ...
      <div class="step-dark-left" >Pilih Pelajaran</div>
...
?>
      ...
      <tr>
        ...
        <td><a class="plajaran" href="Laporan_penilaian.php?id_pelajaran=<?php echo $row['id_pelajaran']; ?>&Semester=<?php echo $Semester; ?>&kelas=<?php echo $kelas; ?>"><?php echo $row['nama_pelajaran']; ?></a></td>
