...
$rowi = mysql_fetch_assoc($eq);
 ?>
    ...
    <form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="upload_judul2.php" method="post"  id="contact_form" enctype="multipart/form-data">
<fieldset>

<!-- Form Name -->
<legend>Permohonan TA</legend>
<input type="hidden" name="idsiswa" value="<?php echo $rowi['id_siswa']; ?>">
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label">Judul TA</label>  
...
<div class="form-group">
  <label class="col-md-4 control-label">Upload TA</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
...
include "conn.php";
$popo=$rowi['id_siswa'];
 $q="SELECT * FROM `tga` where id_siswa='$popo'";
  $qe=mysql_query($q);
...
<form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="edit9.php" method="post"  id="contact_form" enctype="multipart/form-data">
<fieldset>
