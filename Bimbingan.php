...
$rowi = mysql_fetch_assoc($eq);
 ...
 ?>
    ...
    <form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="add8.php" method="post"  id="contact_form" enctype="multipart/form-data">
<fieldset>

<!-- Form Name -->
<legend>Permohonan Bimbingan</legend>
<input type="hidden" name="idsiswa" value="<?php echo $rowi['id_siswa']; ?>">
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label">Tanggal Permohonan</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="dat" placeholder="First Name" class="form-control"  type="Date">
    </div>
  </div>
</div>
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <textarea  name="com" type="text" class="form-control"  ></textarea>
    </div>
  </div>
</div>
<!-- Text input-->
...
include "conn.php";
$popo=$rowi['id_siswa'];
 $q="SELECT * FROM `bimbingan` where ids='$popo'";
  $qe=mysql_query($q);
while ($row =mysql_fetch_array($qe)) {
?>  
<tr>
<td><?php echo $row['Date']; ?></td>
<td><textarea readonly=""><?php echo $row['Comment']; ?></textarea></td>
<td><?php echo $row['Revisi']; ?></td>
<td><?php echo $row['Setuju']; ?></td>
<td><textarea readonly=""><?php echo $row['Comment2']; ?></textarea></td>
...
<form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="add8.php" method="post"  id="contact_form">
<fieldset>
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input style=" width: 154%" name="dat"  class="form-control"  type="Date" value="<?php echo $row['Date']; ?>">
    </div>
  </div>
</div>
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <textarea style=" width: 234%" name="com" type="text" class="form-control"  ><?php echo $row['Comment']; ?></textarea>
    </div>
  </div>
</div>
