...
<div class="row">
  <div class="col-md-8" style="width: 76%;"> 
      ...
      <div class="clear"></div>
    <br><br><br><br><br>
  <form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="Input_nilai_data_admin.php" method="GET"  id="contact_form">
...
<?php 
$id_plajaran = $_GET['id_pelajaran'];
 ?>

<input type="hidden" name="id_pelajaran" value="<?php echo $id_plajaran; ?>">
<div class="form-group">
