...
<div class="row">
  <div class="col-md-8"> 
      ...
      <div class="clear"></div>
    <br><br><br><br><br>
    <form action="add_nilai_admin.php" >  
...
?>
      ...
      <input type="hidden" name="id_pelajaran" value="<?php echo $pelajaran; ?>">
            <button style="margin-left: 596px;" type="submit" class="btn btn-warning" >Simpan <span class="glyphicon glyphicon-send"></span></button>
              <input type="hidden" name="id_kelas" value="<?php echo $keas; ?>">
    </form>
 </div>
 </div>
</div>
