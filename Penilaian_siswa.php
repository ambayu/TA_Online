...
<div class="row">
  <div class="col-md-8"> 
      ...
      <div class="step-light-left" >Cetak Raport</div> 
     
           <div class="clear"></div>
    <br><br><br><br><br>
  <form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="Laporan_penilaian_siswa.php" method="GET"  id="contact_form">
