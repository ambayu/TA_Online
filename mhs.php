...
<div class="container">
    ...
    <form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="add4.php" method="post"  id="contact_form">
<fieldset>
...
<div class="form-group">
  <label class="col-md-4 control-label" >NIM</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="nip" placeholder="Nomor Induk Mahasiswa" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<?php
include "conn.php";
 $q="SELECT * FROM `data_siswa` ORDER BY nis ASC";
  $qe=mysql_query($q);
...
?>
      ...
      <tr>
        ...
        <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal<?php echo $row['id_siswa']; ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
          <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')" href="delete4.php?id=<?php echo $row['id_siswa']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
...
<form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="edit4.php" method="post"  id="contact_form">
<fieldset>
