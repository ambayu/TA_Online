...
<div class="row">
  <div class="col-md-8"> 
      ...
      <div class="step-dark-left"   >Semester & Kelas</div>
      ...
      <div class="clear"></div>
    <br><br><br><br><br>
  <form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="Input_nilai_data_guru.php" method="GET"  id="contact_form">
<legend>Pilih Semester & Kelas</legend>
