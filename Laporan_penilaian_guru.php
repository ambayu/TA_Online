...
<?php 
$semester=$_GET['Semester'] ?>
    <form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="Laporan_penilaian_guru.php" method="GET"  id="contact_form">
...
<div class="form-group">
  <label class="col-md-4 control-label"></label>
  <div class="col-md-4">
   <a class="btn btn-waarning" href="Laporan_penilaian_guru.php?Semester=<?php echo $semester ?>&id_pelajaran=<?php echo $pelajaran; ?>&kelas=<?php echo $kelas; ?>">Reset<span class="glyphicon glyphicon-send"></span></a>
  </div>
</div>
</td>
</tr>
