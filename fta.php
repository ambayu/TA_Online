...
$q="SELECT * FROM `tga` where id_siswa='$ds' ";
$qe=mysql_query($q);
...
<td><?php echo $rowsi['juduls']; ?></td>
<td><a href="download.php?file=<?php echo $rowsi['file']; ?>"><?php echo $rowsi['file']; ?>
  
</td>

<td><?php echo $rowsi['Revisi']; ?></td>
<td><textarea readonly><?php echo $rowsi['Comment']; ?></textarea></td>
<td><?php echo $rowsi['dt']; ?></td>
...
<form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="edit10.php" method="post"  id="contact_form" enctype="multipart/form-data"> 
<fieldset>
...
<!-- Text input-->
<input name="id" value="<?php echo $rowsi['No']; ?>" style="position: absolute;" type="hidden">
<input name="pass2" value="<?php echo $rowsi['password']; ?>" style="position: absolute;" type="hidden">
<div class="form-group">
  <label class="col-md-4 control-label">Comment</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <textarea style=" width: 234%" name="Comment" class="form-control" rows="4" cols="50"><?php echo  $rowsi['Comment'] ; ?></textarea>
    </div>
  </div>
</div>
<div class="form-group">
...
<div class="form-group">
  ...
  <select style=" width: 234%" name="ty" class="form-control">
    <option name="ty" ><?php echo $rowsi['dt']; ?></option>
