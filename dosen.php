...
<div class="form-group">
  <label class="col-md-4 control-label" >NID</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="nip" placeholder="Nomor Induk Dosen" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<?php
include "conn.php";
 $q="SELECT * FROM `data_guru` order by nip asc";
  $qe=mysql_query($q);
...
?>
      ...
      <tr>
        ...
        <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal<?php echo $row['id_guru']; ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
          <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')" href="delete3.php?id=<?php echo $row['id_guru']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
...
<div class="form-group">
  <label class="col-md-4 control-label" >NID</label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="nip" value="<?php echo $row['nip']; ?>" placeholder="Nomor Induk Do" style=" width: 234%" class="form-control"  type="text">
    </div>
  </div>
</div>
