...
<form style="background-color: #ffff;border: 1px solid #e3e3e3;width: 91%;" class="well form-horizontal" action="Input_nilai_data_admin.php" method="get"  id="contact_form">
<fieldset>
...
$filter_pelajaran="";
 ...
 ?>
 <form action="add_nilai_admin2.php" method="POST" >  
...
$id=$_GET['Semester'];
$kelas=$_GET['kelas'];
$napel=$namapelajaran['nama_pelajaran'];
