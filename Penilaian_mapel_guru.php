...
?>
      ...
      <tr>
        ...
        <td><a class="plajaran" href="Laporan_penilaian_guru.php?id_pelajaran=<?php echo $row['id_pelajaran']; ?>&Semester=<?php echo $Semester; ?>&kelas=<?php echo $kelas; ?>"><?php echo $row['nama_pelajaran']; ?></a></td>
