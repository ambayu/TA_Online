...
$kelas=$_GET['pelajaran'];
  
 $q="SELECT * FROM tbl_jadwal INNER JOIN setup_pelajaran ON tbl_jadwal.id_pelajaran=setup_pelajaran.id_pelajaran WHERE tbl_jadwal.id_guru='$id' ";
  $qe=mysql_query($q);
    $no=0;
...
?>
      ...
      <tr>
        ...
        <td><a class="plajaran" href="Input_nilai_data_guru.php?id_pelajaran=<?php echo $row['id_pelajaran']; ?>&Semester=<?php echo $semester; ?>&kelas=<?php echo $kelas; ?>"><?php echo $row['nama_pelajaran']; ?></a></td>
