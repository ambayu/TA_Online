...
?>
      ...
      <tr>
        ...
        <td>
           <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal<?php echo $row['id_pelajaran']; ?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
          <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')" href="delete.php?id=<?php echo $row['id_pelajaran']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
...
<!-- Modal -->
<div class="modal fade" id="myModal<?php echo $row['id_pelajaran']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel<?php echo $row['id_pelajaran']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel<?php echo $row['id_pelajaran']; ?>">Edit Data</h4>
      </div>
...
<form action="edit.php" method="post">
  <div class="form-group">
    ...
    <input name="nomor" type="text" class="form-control" id="nm<?php echo $row['id_pelajaran']; ?>" value="<?php echo $row['id_pelajaran']; ?>">
  </div>
  <div class="form-group">
    <label for="gd">Nama Pelajaran</label>
    <input name="nama" type="text" class="form-control" id="gd<?php echo $row['nama_pelajaran']; ?>" value="<?php echo $row['nama_pelajaran']; ?>">
  </div>
