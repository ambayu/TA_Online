...
<div class="row">
 ...
 <div class="step-no-off">1</div>
      ...
      <div class="step-light-left" ><a class="header-repeat" >Pilih Pelajaran</a></div>
      <div class="step-light-right">&nbsp;</div>
      <div class="step-no-off">3</div>
      <div class="step-light-left" ><a class="header-repeat" >Laporan Penilaian</a></div>
      <div class="step-light-right">&nbsp;</div>
      <div class="step-no">4</div>
      <div class="step-dark-left"><a class="header-repeat"  >Cetak Raport Siswa</a></div>
       
    <br><br><br><br><br>
<?php 
$semester=$_GET['Semester'] ?>
    <form style="background-color: #ffff;border: 1px solid #e3e3e3;" class="well form-horizontal" action="" method="GET"  id="contact_form">
...
<div class="form-group">
  <label class="col-md-4 control-label"></label>
  <div class="col-md-4">
   <a class="btn btn-waarning" href="Cetak_raport.php?Semester=<?php echo $semester ?>">Reset<span class="glyphicon glyphicon-send"></span></a>
  </div>
</div>
</td>
</tr>
...
<th class="table-header-repeat" style="text-align: center;"><a class="header-repeat" href="">Print</a></th>
...
include "conn.php";
 ...
 $q="SELECT * FROM  `data_siswa` where $filter_guru $filter_siswa $filter_pelajaran Order by Kelas";
  $qe=mysql_query($q);
    $no=0;
while ($row =mysql_fetch_array($qe)) {
?>
<tr>
<?php $sui=$row['id_siswa'] ?>
        <td><?php echo $no=$no+1;?></td>
        <td><?php echo $row['nama_siswa']; ?></td>
        <td><?php echo $row['nis']; ?></td>
            <td style="text-align: center;"><?php echo $row['Kelas']; ?></td>
            <td style="text-align: center;"><a class="btn btn-danger btn-sm" href="Print_raport.php?id=<?php echo $row['id_siswa']; ?>&<?php echo $semester; ?>&kelas=<?php echo $row['Kelas']; ?>"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a></td> 
...
$kelas=$_GET['kelas'];
 ...
 $q="SELECT * FROM  `data_siswa` where Kelas='$kelas' Order by Kelas ";
  $qe=mysql_query($q);
    $no=0;
while ($row =mysql_fetch_array($qe)) {
?>
...
<?php $sui=$row['id_siswa'] ?>
        ...
        <td><?php echo $row['nis']; ?></td>
            <td style="text-align: center;"><?php echo $row['Kelas']; ?></td>
            <td style="text-align: center;"><a class="btn btn-danger btn-sm" href="Print_raport.php?id=<?php echo $row['id_siswa']; ?>&semester=<?php echo $semester; ?>&kelas=<?php echo $row['Kelas']; ?>"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a></td> 
